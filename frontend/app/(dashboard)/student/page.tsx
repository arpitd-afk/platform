...
export default function StudentDashboard() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      icon: Trophy,
      label: "Tournaments",
      desc: activeTournament ? "Active now" : "Browse all",
      color: "#7C3AED",
      bg: "#EDE9FE",
    },
  ];
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #FFFCF8 0%, rgba(200,150,30,0.06) 100%)",
        }}
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-sm mt-1" style={{ color: "var(--text-muted)" }}>
            {pendingCount > 0
              ...
              : "All assignments complete — great work!"}
          </p>
        </div>
        {user?.rating && (
          <div className="text-center hidden sm:block">
            ...
            <div
              className="text-xs flex items-center gap-1 justify-center mt-0.5"
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <div
                  ...
                  style={{ background: "rgba(200,150,30,0.10)" }}
                >
                ...
                <div>
                  ...
                  <div
                    ...
                    style={{ color: "var(--text-muted)" }}
                  >
                    by {upcomingClass.coach_name || "Your Coach"}
                  </div>
                  {upcomingClass.scheduled_at && (
                    ...
                    >
                      <Clock size={11} />
                      {new Date(upcomingClass.scheduled_at).toLocaleString(
                        "en-IN",
                        {
                          weekday: "short",
                          hour: "2-digit",
              ...
              <Link
                href={`/classroom/${upcomingClass.id}`}
