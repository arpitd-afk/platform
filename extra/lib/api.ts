...
export const academyAPI = {
  ...
  getStudents: (id: string, params?: any) => api.get(`/academies/${id}/students`, { params }),
...
export const gameAPI = {
  ...
  makeMove: (id: string, move: string) => api.post(`/games/${id}/move`, { move }),
...
export const billingAPI = {
  ...
  getInvoices: (academyId: string) =>
    api.get(`/billing/invoices/${academyId}`),
