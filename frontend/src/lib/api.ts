...
export const gamesAPI = {
  ...
  savePractice: (d: any) => api.post("/games/save", d),
};
...
export const studentInvoicesAPI = {
  ...
  download: (id: string, filename: string) =>
    downloadFile(`/student-invoices/${id}/pdf`, filename),
...
export const studentReportsAPI = {
  ...
  download: (studentId: string, periodDays = 90, filename: string) =>
    downloadFile(
      `/student-reports/${studentId}/pdf?periodDays=${periodDays}`,
      filename,
    ),
};
